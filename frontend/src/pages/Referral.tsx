...
interface TriageData {
  category: 'routine' | 'consult' | 'urgent'
  demoMode?: boolean
}
...
function Referral() {
  ...
  const triage = location.state?.triage as TriageData | undefined
  ...
  const facilities: Facility[] = [
    ...
    },
    {
      ...
      type: 'CHC',
      distance: '8.7 km',
      doctor: 'Medical Officer available',
      availability: 'Available today',
      queue: '7 patients',
    },
    {
      ...
      <main className="referral-page">
        ...
        <div className="workflow referral-workflow">
          ...
          <div className="workflow-step active">
            <span>2</span>
            <label>{t('referral', 'facility')}</label>
          </div>
          ...
          <div className="workflow-step">
            <span>3</span>
            <label>{t('referral', 'referral')}</label>
          </div>
          ...
          <div className="workflow-step">
            <span>4</span>
            <label>{t('referral', 'followUp')}</label>
          </div>
        </div>
        ...
        <section className="referral-summary">
          <div>
            <span className="section-kicker">
              {t('referral', 'triageResult')}
            </span>

            <h2>
              {triage?.category === 'urgent'
                ? t('referral', 'urgent')
                : triage?.category === 'consult'
                  ? t('referral', 'consult')
                  : t('referral', 'routine')}
            </h2>

            <p>
              {t('referral', 'triageSummary')}
            </p>
          </div>
          ...
          <div className="referral-score">
            ...
            <strong>{rppg?.trustScore ?? '—'}/100</strong>
          </div>
        </section>
        ...
        <section className="facility-section">
          <div className="section-heading">
            <div>
              ...
              <h2>{t('referral', 'chooseFacility')}</h2>
            </div>

            <p>{t('referral', 'facilityDemo')}</p>
          </div>
        ...
        <section className="referral-details">
          <div className="section-heading">
            <div>
              ...
              <h2>{t('referral', 'referralDetails')}</h2>
            </div>
          </div>
          ...
          <div className="referral-detail-grid">
            <div className="detail-box">
              ...
              <div>
                <span>{t('referral', 'preferredDate')}</span>
                <strong>Today</strong>
              </div>
            </div>
            ...
            <div className="detail-box">
              ...
              <div>
                <span>{t('referral', 'reason')}</span>

                <strong>
                  {triage?.category === 'urgent'
                    ? t('referral', 'urgentReview')
                    : t('referral', 'clinicalReview')}
                </strong>
              </div>
            </div>
          </div>
        ...
        <section className="referral-safety">
          ...
          <div>
            <strong>{t('referral', 'safetyTitle')}</strong>

            <p>{t('referral', 'safetyText')}</p>
          </div>
        </section>
